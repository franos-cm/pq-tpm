...
// Custom Dilithium prototypes
#if ALG_DILITHIUM
TPM_RC TPM2B_PUBLIC_KEY_DILITHIUM_Unmarshal (TPM2B_PUBLIC_KEY_DILITHIUM* target, BYTE** buffer, INT32* size);
UINT16 TPM2B_PUBLIC_KEY_DILITHIUM_Marshal   (TPM2B_PUBLIC_KEY_DILITHIUM* source, BYTE** buffer, INT32* size);

TPM_RC TPM2B_PRIVATE_KEY_DILITHIUM_Unmarshal (TPM2B_PRIVATE_KEY_DILITHIUM* target, BYTE** buffer, INT32* size);
UINT16 TPM2B_PRIVATE_KEY_DILITHIUM_Marshal   (TPM2B_PRIVATE_KEY_DILITHIUM* source, BYTE** buffer, INT32* size);

TPM_RC TPMS_DILITHIUM_PARMS_Unmarshal      (TPMS_DILITHIUM_PARMS* target, BYTE** buffer, INT32* size);
UINT16 TPMS_DILITHIUM_PARMS_Marshal        (TPMS_DILITHIUM_PARMS* source, BYTE** buffer, INT32* size);

TPM_RC TPM2B_SIGNATURE_DILITHIUM_Unmarshal  (TPM2B_SIGNATURE_DILITHIUM* target, BYTE** buffer, INT32* size);
UINT16 TPM2B_SIGNATURE_DILITHIUM_Marshal    (TPM2B_SIGNATURE_DILITHIUM* source, BYTE** buffer, INT32* size);

TPM_RC TPMS_SIGNATURE_DILITHIUM_Unmarshal   (TPMS_SIGNATURE_DILITHIUM* target, BYTE** buffer, INT32* size);
UINT16 TPMS_SIGNATURE_DILITHIUM_Marshal     (TPMS_SIGNATURE_DILITHIUM* source, BYTE** buffer, INT32* size);
#endif
