// ...existing code...
#ifndef DEBUG_HEADER_AA
#define DEBUG_HEADER_AA
...
#else
extern TPM2B_HASH_TEST_KEY c_hashTestKey;
#endif
...
#else
extern TPM2B_HASH_TEST_DATA c_hashTestData;
#endif
...
#  else
extern TPM2B_SHA1 c_SHA1_digest;
#  endif
#endif
...
#  else
extern TPM2B_SHA256 c_SHA256_digest;
#  endif
#endif
...
#  else
extern TPM2B_SHA384 c_SHA384_digest;
#  endif
#endif
...
#  else
extern TPM2B_SHA512 c_SHA512_digest;
#  endif
#endif
...
#  else
extern TPM2B_EMPTY c_SM3_256_digest;
#  endif
#endif
...
#  else
extern TPM2B_EMPTY c_SHA3_256_digest;
#  endif
#endif
...
#  else
extern TPM2B_EMPTY c_SHA3_384_digest;
#  endif
#endif
...
#  else
extern TPM2B_EMPTY c_SHA3_512_digest;
#  endif
#endif

#endif  // DEBUG_HEADER_AA